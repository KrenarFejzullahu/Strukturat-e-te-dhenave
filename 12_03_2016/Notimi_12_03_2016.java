import javax.swing.*;
public class Notimi_12_03_2016
{
  public static void main(String[] args)
  {
    
    int piket = new Integer(JOptionPane.showInputDialog("Numri i pikeve: ")).intValue();
     ...
     switch(piket)
     {
       ...
       JOptionPane.showMessageDialog(null,"Keni "+piket+ " pike \nNota: \"F\" ");
       break;
